...
class LLMAnalyzer:
    ...
    def _get_basic_prompts(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "analysis_prompts": {
                "technical_challenges": "Analyze the entire repository history to identify 2-3 most significant technical challenges.",
...
Please provide a comprehensive analysis of the entire project history, focusing on 2-3 significant technical challenges. For each challenge, you must:
...
2. Technical Context:
{self.prompts['analysis_prompts']['technical_context']}

3. Implementation Details:
{self.prompts['analysis_prompts']['implementation_details']}

Important Requirements:
- You MUST identify and analyze 2-3 significant technical challenges
